...
UPSTREAM_GITLAB_NGINX_CONFIG="lib/support/nginx/gitlab"
UPSTREAM_GITLAB_NGINX_SSL_CONFIG="lib/support/nginx/gitlab-ssl"

GITLAB_UPSTREAM_CONFIGS="${UPSTREAM_GITLAB_DATABASE_YML} ${UPSTREAM_GITLAB_GITLAB_YML} ${UPSTREAM_GITLAB_PUMA_RB} ${UPSTREAM_GITLAB_RELATIVE_URL_RB} ${UPSTREAM_GITLAB_RESQUE_YML} ${UPSTREAM_GITLAB_SECRETS_YML} ${UPSTREAM_GITLAB_SMTP_SETTINGS_RB} ${UPSTREAM_GITLAB_NGINX_CONFIG} ${UPSTREAM_GITLAB_NGINX_SSL_CONFIG}"
